...
1. Clone the repository
   ```bash
   git clone https://github.com/e-ogugua/ai-finance-advisor.git
...
```
NEXT_PUBLIC_APP_NAME="ai-finance-advisor"
NEXT_PUBLIC_APP_URL="https://ai-finance-advisor.vercel.app"
```
